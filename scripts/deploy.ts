...
import { StatefullMultisig } from '../src/contracts/statefullMultisig'
...
async function main() {
    await StatefullMultisig.compile()
    ...
    const instance = new StatefullMultisig(
    ...
    console.log('StatefullMultisig contract was successfully deployed!')
